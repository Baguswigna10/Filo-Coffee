...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        ::-webkit-scrollbar-thumb { background: rgba(201, 168, 124, 0.3); border-radius: 6px; }
...
<body class="min-h-screen">
    ...
    <div class="fixed top-20 right-4 z-50 space-y-2" id="flash-messages">
        @if(session('success'))
        <div class="flash-toast glass border border-green-500/20 text-green-400 px-5 py-3 rounded-2xl shadow-2xl flex items-center gap-3" role="alert">
            <svg class="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/></svg>
            <span class="text-sm font-medium">{{ session('success') }}</span>
        </div>
        @endif
        @if(session('error'))
        <div class="flash-toast glass border border-red-500/20 text-red-400 px-5 py-3 rounded-2xl shadow-2xl flex items-center gap-3" role="alert">
