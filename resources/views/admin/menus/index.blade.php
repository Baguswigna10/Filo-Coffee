            ...
            <tr>
                <td>
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-olive-900 font-medium text-sm">{{ $menu->name }}</p>
                            @if($menu->is_featured)
                            <span class="inline-flex items-center gap-1 text-mocca-dark text-[0.65rem] font-medium">
                ...
                <td>
                    <span class="text-olive-850/60 text-xs font-semibold bg-olive-50 px-2.5 py-1 rounded-lg">{{ $menu->category }}</span>
                </td>
                <td class="text-olive-900 font-bold">{{ $menu->formatted_price }}</td>
                <td>
                ...
                <td class="text-right">
                    <div class="flex items-center justify-end gap-1">
                        <a href="{{ route('admin.menus.edit', $menu) }}" class="w-8 h-8 flex items-center justify-center rounded-lg text-olive-900/30 hover:text-mocca-dark hover:bg-mocca/10 transition-all duration-200">
            ...
            <tr>
                <td colspan="5" class="!py-16 text-center">
                    <div class="flex flex-col items-center gap-3">
                        ...
                        <p class="text-olive-900/30 text-sm">Belum ada data menu.</p>
                    </div>
                </td>
            </tr>
            @endforelse
